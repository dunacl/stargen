...
/*
* Structure for the definition of Temperature and Color of a Star based in this
* web link http://www.enchantedlearning.com/subjects/astronomy/stars/startypes.shtml
*/

typedef struct star_aditional_data
{
  int star_types;
  char *star_type_id;
  char *star_color;
  int star_temperature_min;
  int star_temperature_max;
  long double star_color_mass; // In relation to Sun's mass
  long double star_luminosity; // In relation to Sun's luminosity
} star_aditional_data;
